...
namespace WebApplication2.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        public OrderController(IMQTTService mqttService)
        {
        ...
        public async Task<IActionResult> CreateOrder([FromBody] OrderRequest order)
        {
            ...
            // Gửi thông tin đơn hàng qua MQTT
            await _mqttService.PublishOrder(order);
            return Ok(new { message = "Đơn hàng đã được gửi!" });
        }
    }
}